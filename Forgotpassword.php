...
<input type="submit" value="Continue" name="save" class="btn btn-dark btn-block"  style="color:#fff" /><br />
    ...
    <?php
	if(isset($_POST['save']))
	{$sql="select emailid FROM addexpert where emailid='$_POST[em]'";
...
$message = 'Your Verification Code is '.$code.'.Please use this code to recover your Password. Click the following link:<br/>http://localhost/carencure/recoverpasswordexp.php?id='.$em.'<br/> <br/> <p> Health Care</p>';
$mail = new PHPMailer;
$mail->isSMTP();
