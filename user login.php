...
<h4 class="text-center" style="color:#ca9a61; letter-spacing:2pt">User Sign In</h4>
...
<a href="forgetpassworduser.php">Forgot Password?</a></form>
<a href="user register.php">New User? Click Here To Login</a></form>

<?php
if(isset($_POST['reg'])){
	$sql="select *FROM userregister WHERE email='$_POST[em]' AND password='$_POST[pwd]'";
	$result=$conn ->query($sql);
	if($result->num_rows>0){
		$_SESSION['un']=$_POST['em'];
