...
<input type="text" placeholder="Username" class="form-control" name="em" required="required" /></div><br />
<div class="input-group">
...
<?php
if(isset($_POST['reg'])){
	$sql="select *FROM admin WHERE username='$_POST[em]' AND password='$_POST[pwd]'";
	$result=$conn ->query($sql);
	if($result->num_rows>0){
		$_SESSION['ad']=$_POST['em'];
		echo"<script>window.location='admin/surgery.php';</script>";
	}else
	{
